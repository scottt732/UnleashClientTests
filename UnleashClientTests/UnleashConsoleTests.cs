...
namespace UnleashClientTests
{
    ...
    public class UnleashConsoleTests
    {
        ...
        public void Test1()
        {
            ...
            serviceCollection.AddUnleash(settings => { settings.AppName = "MyApplication"; });
            ...
            {
                var unleash1 = scope.ServiceProvider.GetRequiredService<IUnleash>(); // Set breakpoint here
            ...
            var unleash = serviceProvider.GetRequiredService<IUnleash>();
            unleash.Dispose();
        }
    }
}
